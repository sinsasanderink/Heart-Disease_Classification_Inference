...
def main(model_name, logger):
    ...
    try:
        ...
        accuracy = accuracy_score(labels, model.predict(processed_inference_data))
        print(accuracy)
        logger.info(f"Checking inference accuracy: {accuracy}")
...
if __name__ == "__main__":
    ...
    if(args.model == 'svm'):
        model_name = 'model2_svm.joblib'
    else:
        model_name = 'model1_adaboost.joblib'
