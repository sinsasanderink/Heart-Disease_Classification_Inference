...
# apply same pre-processing and feature engineering techniques as applied
...
def encode_features(df, features):
    ...
    '''
    # Creating dataframe for features defined in ONE_HOT_ENCODED_FEATURES
    # Implement these steps to prevent dimension mismatch during inference
    encoded_df = pd.DataFrame(
        columns=ONE_HOT_ENCODED_FEATURES)  # from constants.py
    ...
    # Checking mismatch of dimensions during inference
